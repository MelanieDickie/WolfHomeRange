...
Delta2020plot <- raster(here::here("data", "Delta2020plot.tif"))
...
#Remove the negative values that didn't get masked out - these are not plausible
Delta2020plot_df<-subset(Delta2020plot_df, Delta2020plot >=0)
